...
public function data_user()
	...
	public function analisis()
	{
		...
		$data['clara'] = $model->joinwhere('tb_motor', 'tb_users', 'tb_motor.id_user=tb_users.id_user', $where);
		echo view('data_analisis', $data);
		echo view('footer');
		//echo view('theme_panel');
		}else{
		return redirect()->to('home/login');
	...
	public function data_history()
	{
		...
		// $where=array('tanggal' => date('Y-m-d'));
		$data['clara'] = $model->join('tb_motor', 'tb_users', 'tb_motor.id_user=tb_users.id_user');
	...
	public function aksi_tambah_analisis()
	{
			...
			$model->tambah('tb_motor', $isi);
		
		return redirect()->to('home/analisis');
	}
