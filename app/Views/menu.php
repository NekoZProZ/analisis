...
<?php if(session()->get('level')==1){
 ?>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/analisis') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Analisis</span></a></li>
                        ...
                        <?php } ?>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/data_history') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">History Analisis</span></a></li>
